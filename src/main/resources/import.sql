...
INSERT INTO restaurantes (bairro, cep, logradouro, numero, nome, taxa_entrega, codigo_cozinha, codigo_cidade) VALUES ('Nossa Senhora das Graças', '56.00-000', 'R. Joaquim Sampaio', '95A', 'Wilson Pizzas', '5', '1', '2');
INSERT INTO restaurantes (bairro, cep, logradouro, numero, nome, taxa_entrega, codigo_cozinha, codigo_cidade) VALUES ('Atrás da Banca', '56308-155', 'Av. Cardoso de Sá', '1', 'Habib\'s Petrolina', '12', '4', '1');
INSERT INTO restaurantes (bairro, cep, logradouro, numero, nome, taxa_entrega, codigo_cozinha, codigo_cidade) VALUES ('Centro', '56302-000', 'Av. Guararapes', '2244', 'China Real', '8', '2', '1');
